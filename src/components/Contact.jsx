  ...
  return (
    <section id="contact" className="section section-alt">
      <div className="container">
        <h2 className="section-title"><span className="text-accent">//</span> contact</h2>
        <div className="row">
          <div className="col-lg-6">
            <p className="about-text">Have a project or just want to talk? Reach out.</p>
            <div className="contact-links">
              <a
                href="https://github.com/faustososa22"
              ...
              <a
                href="https://linkedin.com/in/fausto-sosa"
                className="contact-link"
                target="_blank"
                rel="noreferrer"
              >
